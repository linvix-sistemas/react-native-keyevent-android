package com.reactnativekeyevent-android;
...
@ReactModule(name = Keyevent-androidModule.NAME)
public class Keyevent-androidModule extends ReactContextBaseJavaModule {
  public static final String NAME = "Keyevent-android";
  ...
  public Keyevent-androidModule(ReactApplicationContext context) {
