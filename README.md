...
```js
import NativeModuleTectToySunmiSDK, { TectoyLCDFuncaoEnum, TectoyLCDMultiTextoType } from '@linvix-sistemas/react-native-keyevent-android';
```

Veja a pasta [example](example/src/App.tsx) para verificar como utilizar.

---
## [Types](src/types/tectoysunmi-types.ts) - [Enums](src/enums/keyevent-android-enum.ts) 
---
...
### ControlarLCD - [TectoyLCDFuncaoEnum](src/enums/keyevent-android-enum.ts#L1)
```ts
